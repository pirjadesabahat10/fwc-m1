...
\fancyhf{}
\fancyhead[L]{
        \includegraphics[width=0.4\textwidth]{images/iiitb_logo.png}
}
\fancyhead[R]{
...
\begin{center}
	{\Huge \textbf{\textcolor{blue}{GATE 2009 EE, $13^{th}$ Question Analysis}}}
\end{center}

\section*{\textbf{Question 13}}

\begin{flushleft}
13) What are the minimum numbers of NOT gates and 2-input OR gates required to design the logic of the driver for this 7-segment display?
\end{flushleft}
...
\begin{center}
\includegraphics[width=0.6\textwidth]{images/platform.jpg}
\end{center}
